...
manifest_2016_pre <- read.delim("2016_manifest_rockiguana_V2", sep = "\t", header = TRUE)
metadata_2016_pre <- read.csv("metadata_2016.csv", header=T, sep=",")
sum(metadata_2016_pre$sample.id %in% manifest_2016_pre$sample.id)

intersect(manifest_2016_pre$sample.id, metadata_2016_pre$sample.id)
setdiff(metadata_2016_pre$sample.id, manifest_2016_pre$sample.id)
setdiff(manifest_2016_pre$sample.id, metadata_2016_pre$sample.id)

metadata2016_qiime2_final <- metadata_2016_pre %>% filter(sample.id %in% manifest_2016_pre$sample.id)
write.csv(metadata2016_qiime2_final, "metadata2016_qiime2_final.csv", row.names = FALSE)
